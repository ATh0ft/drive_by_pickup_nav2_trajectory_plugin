...
// this is the function that configures the planner server.
// it set up the costmap 
// extrat the planner plugins into a list 
// set the planning frequency 
// Initialize topics 
...
//this is a function to activate the topics 
//then in activete the planner plugins and itterates ?? 
//then it validates the plan 
nav2_util::CallbackReturn
...
//a function to deactivate? 
//deactivates the action servers 
//shuts down the planner plugins
//resets the dynamic parametesrs? 
//destroy bond to what? 
nav2_util::CallbackReturn
